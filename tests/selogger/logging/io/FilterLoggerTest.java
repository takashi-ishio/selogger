...
public class FilterLoggerTest {
	...
	public void testFilter() {
		...
		FilterLogger filter = new FilterLogger(mem, new FixedId(1), new FixedId(3), messages);
	...
	public void testEnableAndDisable() {
		MemoryLogger mem = new MemoryLogger();
		StringLogger messages = new StringLogger();
		FilterLogger filter = new FilterLogger(mem, new FixedId(1), new FixedId(1), messages);
